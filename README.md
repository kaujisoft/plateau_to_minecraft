...
<img src="img/yokohama_google.png" width="60%">

*実際の横浜市中区の衛星写真。インデックス図と照らし合わせることでエリアを確認できます。*
...
- 本アプリ（HTMLファイルを含む全データ）の著作権は制作者（kauji）に帰属します。
- 購入者ご本人が利用する目的でのみ提供されます。
- **ファイルの転載・販売・再販、および第三者がダウンロード・閲覧できる場所への公開を禁止します。**
